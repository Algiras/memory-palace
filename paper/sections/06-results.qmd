...
| **Memory Palace**             | **58.2%**| **Zero Trainable Parameters**| **Unlimited** |

: SOTA Embedding System Comparison {#tbl-sota}

While Memory Palace's hierarchical approach achieves competitive retrieval (61.8% keyword, 89% with SMASHIN encoding) with:
