...
For zero-shot retrieval evaluation, we use the BEIR benchmark [@yang2018hotpotqa], which includes:
...
2. **Contriever** [@karpukhin2020dense]: Self-supervised dense retriever trained on unlabeled data with contrastive learning.

3. **ColBERT**: Late interaction model computing fine-grained relevance between query and document tokens.
